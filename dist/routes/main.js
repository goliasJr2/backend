...
exports.mainRouter.use('/auth', authRoutes_1.default);
exports.mainRouter.use('/usuario', usuarioRoutes_1.default);
exports.mainRouter.use("/servicos", servicoRoutes_1.default);
